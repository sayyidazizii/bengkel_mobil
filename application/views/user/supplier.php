            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mt-5">
                    ...
                    <div class="container mt-3" style="width:100vw;">
                        ...
                        if ($_SESSION['level'] == 1) {
                        ?>
                            <a href="<?php echo base_url('User/tambahuser') ?>" class="btn btn-primary mb-3">Tambah Supplier</a>
                        <?php
                        }
                        ?>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <?php if ($row->id_level == 3) { ?>
                                            <p class="badge bg-warning text-light">Supplier</p>
                                        <?php } ?>
                                    </td>
                                    <?php
                                    if ($_SESSION['level'] == 1) {
                                    ?>
                                        <td>
                                            ...
                                            <a href="<?php echo base_url('User/hapussuplay') ?>/<?php echo $row->id_user ?>" class="btn btn-danger">Hapus</a>
                                        </td>
                                    <?php
                                    }
                                    ?>
