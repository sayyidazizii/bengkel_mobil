                ...
                <div class="container" style="width:100vw;">
                    <form action="<?php echo base_url('User/editdata') ?>" method="POST">
                        <div class="container" style="width:50vw">
                            ...
                            <input class="form-control mb-3" type="password" name="password" value="<?php echo $user->password?>" required>
                            <label class="form-label" hidden>Level</label>
                            <input class="form-control" type="password" name="id_level" value="<?php echo $user->id_level?>" hidden required>
                            <button type="submit" class="btn btn-primary">Simpan</button>
                            <a href="<?php echo base_url('User/supplier')?>" class="btn btn-secondary">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
